...
export default function Update_Candidate({user, isAdmin, isLogged}) {
 ...
 const yearsArray = [
  ...
  const onSubmit = async (data) =>{
    ...
    // console.log(previous_jobs_salary, jobTitles)
    ...
    if (checkEmpty){
      ...
      if (checkValid){
        ...
        try {
          const res = await axios.patch('/user/update-candidate-by-userId', {
            userId : user._id,
            expected_salary,
            age,
            city,
